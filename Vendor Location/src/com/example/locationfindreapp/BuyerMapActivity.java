...
public class BuyerMapActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (!isInternetPresent) {
			...
			alert.showAlertDialog(BuyerMapActivity.this,
		...
		if (gps.canGetLocation()) {
			...
			alert.showAlertDialog(BuyerMapActivity.this, "GPS Status",
	...
	class LoadPlaces extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(BuyerMapActivity.this);
					...
					if (status.equals("OK")) {
						...
						if (nearPlaces.results != null) {
							...
							ListAdapter adapter = new SimpleAdapter(
									BuyerMapActivity.this, placesListItems,
